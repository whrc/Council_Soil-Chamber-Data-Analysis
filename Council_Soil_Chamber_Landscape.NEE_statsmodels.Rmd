...
#looking at variables  across landscape positions 
```{r}

ggplot(df_long, aes(x = landscape_position, y = flux_value, color = flux_type)) +
  geom_boxplot(position = "dodge") +
  stat_summary(fun.y = mean, geom = "point", position = "dodge", shape = 23, size = 4)+
    #facet_wrap(~landscape_position) +
...
#thawdepth
ggplot(df_long, aes(x = landscape_position, y = thawdepth)) +
  geom_boxplot() +
   #facet_wrap(~landscape_position) +
  labs(title = "Observed thawdepth by Land pos",
       x = "Landscape Position",
       y = "thawdepth") +
  theme_bw() +
...
#VWC
ggplot(df_long, aes(x = landscape_position, y = VWC)) +
  geom_boxplot() +
    labs(title = "Observed VWC by Land pos",
       x = "Landscape Position",
       y = "VWC") +
  theme_bw() +
  stat_summary(fun.y=mean, geom="point", shape=23, size=4)
...
#soil temp 
ggplot(df_long, aes(x = landscape_position, y = soil_temp_10_cm)) +
  geom_boxplot() +
    labs(title = "Observed Soil Temp by Land pos",
       x = "Landscape Position",
       y = "Soil Temp") +
  theme_bw() +
  stat_summary(fun.y=mean, geom="point", shape=23, size=4)
...
#air temp 
ggplot(df_long, aes(x = landscape_position, y = air_temp)) +
  geom_boxplot() +
    labs(title = "Observed Air Temp by Land pos",
       x = "Landscape Position",
       y = "Air Temp") +
  theme_bw() +
  stat_summary(fun.y=mean, geom="point", shape=23, size=4)
...
#inundated
ggplot(df_long, aes(x = landscape_position, y = inundated)) +
  geom_boxplot() +
    labs(title = "Observed Inundated by Land pos",
       x = "Landscape Position",
       y = "AInundated") +
  theme_bw() +
  stat_summary(fun.y=mean, geom="point", shape=23, size=4)
