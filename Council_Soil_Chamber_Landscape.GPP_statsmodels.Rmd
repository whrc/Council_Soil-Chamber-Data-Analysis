---
title: 'Council_Soil_Chamber_Landscape.GPP' #breaking GPP apart by plot type for stats, adapted from GPP_statsmodels.Rmd 
...
#Filter df by landscape position and flux type (GPP, GPP, RECO)
...
anova(model_VWC, model_VWCsoiltemp) #p=0.08, adding temp to VWC does not imrpove model 
anova(model_VWC, model_VWCthawdepth) #p=0.5, adding temp to VWC does not imrpove model 
...
model_homoscedastic <- gls(flux_value ~ landscape_position + VWC, 
                          data = df_GPP, method = "ML")
anova(model_homoscedastic, type = "marginal", test = TRUE)#VWC p = 0.03, *sig
...
#~~~~~~~~~~re-running looking at multiple var structure 
...
anova(model_heteroscedastic, model_heteroscedastic2)#no p, appears using plot type var structure may be better fit, lower AIC/BIC, higher logLik
...
#*muktiple var structure copied over 
```{r}
...
# [1] -3321.921
# [1] -3321.558
# [1] -3322.725 --> marginally best, soil temp + VWC 
# [1] -3321.024
```
