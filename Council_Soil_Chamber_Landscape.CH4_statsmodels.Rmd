---
title: "Council_Soil_Chamber_Landscape.CH4"  #FCH4 in gC/m2/s, flux_CH4 is in nano mol/m2/s - measurement dates range mostly in June and July, with some August and very few Sept measurements 
...
summary(df_FCH4$measurement_date)
plot(df_FCH4$measurement_date,df_FCH4$flux_value)
```
...
```{r}
# Test landscape position effect
...
multiple_reg <- lm(flux_value ~ landscape_position + VWC + soil_temp_10_cm + thawdepth + inundated,
                   data = df_FCH4)
