...
acf(residuals_gls, main = "Autocorrelation of Residuals") #want bars of Lag1 and higher to be below the blue-dotted lines of confidence -- ignore Lag0 ** 
...
summary(MW.NEE.final) #shows landpos, soil temp, and VWC are sig
anova(MW.NEE.final)
#sig diff in soil temp & VWC (p<0.001) but landpos p=0.12
